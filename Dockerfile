...
# Update Packages
RUN apt-get update && apt-get -y apt-utils && apt-get -fuy full-upgrade -y && apt-get -fuy install git aide iptables ufw dnsutils apparmor kmod systemd automake net-tools procps cmake make python3 python3-pip python3-dev
